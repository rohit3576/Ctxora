...
A user pointing QueryPulse at their own key-value database changes only
...
class Settings(BaseSettings):
    ...
    metadata_db_name: str = "querypulse"
    metadata_db_user: str = "querypulse"
    ...
    telemetry_db_name: str = "querypulse"
