# GT-800 GPS Tracker Manual — Version 1.1 (firmware 1.1)
...
incident reconstruction. This revision covers firmware 1.1 units with the faster geofence
event cadence.
...
| E-512 | Cellular watchdog reset — modem recovered by the supervisor |
...
| CH-09 | Geofence breach events | event | 15 s |  |
...
Inspect the antennas and connectors every 15 days. Wipe the antenna radome with a damp
