# RU-500 Transport Refrigeration Unit Manual — Version 2.0
...
standby. This revision covers controller software 2.0.

## Electrical Specifications

| Component | Rating |
| --- | --- |
| Compressor motor | 240 V 3-phase, 12 A |
...
| Discharge cut-out pressure | 22 bar |
...
Replace the compressor oil every 2000 running hours. Replace the filter drier
